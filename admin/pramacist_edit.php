...
if (isset($_POST['update'])) {
    ...
    if (empty(array_filter($errors))) {
        ...
        if (mysqli_query($conn, $user_tbl_update)) {
            $pharmacist_table_update = "UPDATE pharmacist SET  phone='$phone',address='$address',gender='$gender',qualification='$qualification' WHERE user_id= $id";
            if (mysqli_query($conn, $pharmacist_table_update)) {
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <?php
                $id = $_GET['id'];
                $select_query = "SELECT p.id,
                p.phone,p.address, p.gender,p.qualification,user_tbl.user_name as username, user_tbl.user_email,user_tbl.role, user_tbl.id 
  FROM pharmacist as p
