...
if(!preg_match('/^[a-zA-Z0-9]+$/',$cash_history)){
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <select name="doctor" id="" class="form-control">
                                ...
                                <?php
                                $select_doctor_table = "SELECT * FROM doctor ";
                        ...
                        <div class="form-group">
                            <label for="">medication_form_pharamacist</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id=""><?php echo isset($desc) ? $medication_form_pharamacist:'';?></textarea>
