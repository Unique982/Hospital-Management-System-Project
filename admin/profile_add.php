...
if (isset($_POST['update'])) {
    ...
    if (mysqli_query($conn, $user_tbl_update)) {
        ...
        elseif ($user_type === 'patient') {
            $update_query = "UPDATE pateint SET phone='$phone',address='$address' WHERE user_id=  $user_id";
        }
 ...
 <?php
             ...
             WHERE pr.user_id=$user_id";
                ...
                elseif($user_type==='doctors'){
                    $select_query = "SELECT doctors.id as doctors_id,doctors.phone,doctors.address, 
