...
if (isset($_POST['add'])) {
    ...
    $plan_password = mysqli_real_escape_string($conn,$_POST['password']);
                    ...
                    <form action="" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" value="<?php isset($password) ? $qualification:''; ?>" class="form-control" placeholder="Enter Password">
